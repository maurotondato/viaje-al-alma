(function () {
  ...
  window.__BRAND__ = {
    ...
    highlights: [
      "Grupo reducido de hasta 12 mujeres, acompañado durante todo el recorrido.",
    ...
    itinerary: [
      ...
      },
      {
        ...
        photo: "assets/img/real-jaipur-grupo-arco.webp",
    ...
    maldivas: {
      ...
      days: [
        ...
        { title: "Días libres en la isla", date: "28 de febrero al 3 de marzo", text: "Tiempo para explorar Dhigurah, alquilar una bicicleta, caminar sus playas y aguas turquesas. Se recomienda la excursión — opcional y a cargo de cada viajera — para nadar junto a tiburones ballena y mantarrayas." },
    ...
    faqs: [
      ...
      },
      {
        ...
        a: "Las clases de yoga están pensadas para cualquier edad. El grupo del primer viaje, en febrero de 2026, incluyó mujeres de distintas generaciones."
      },
      {
        q: "¿Puedo viajar sola?",
        a: "Sí. Si viajás sin acompañante, te asignamos una compañera de habitación. También podés optar por habitación individual con un costo adicional — consultanos el valor por WhatsApp."
      },
      {
        q: "¿Cuántas personas viajan en el grupo?",
        a: "Es un grupo reducido, de hasta 12 mujeres, acompañado durante todo el recorrido."
      },
      {
